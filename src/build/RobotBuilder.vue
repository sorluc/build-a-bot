  ...
  <div class="content">
    ...
    <div class="bottom-row">
      <div class="bottom part">
        ...
        <button @click="selectPreviousBases(availableParts.bases.length)" class="prev-selector">
          &#9668;</button>
        <button @click="selectNextBases(availableParts.bases.length)" class="next-selector">
          &#9658;</button>
      </div>
    </div>
    <div>
